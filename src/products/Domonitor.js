 ...
 //scroll
  ...
  return (
    <div>
      <div>
        <Navbar />
        <div className="headbg-domonitor">
          <div className="container">
            <div className="row bgheadmat-domonitor">
              <div className="col-md-6 bg-head-1">
                <h3 className="bg-head-domonitor">
                  The all-in-one,solution that lets you monitor anything
                </h3>
                <p className="bg-para-domonitor">
                  Meet DO Monitor a single pane of glass view of your whole IT
                  infrastructure stack
                </p>
                <p className="bg-text-domonitor">Business Email</p>
                <hr className="horizontaltag-domonitor" />
                <button className="btn-domonitor">
                  <span className="btntext-domonitor">Get a demo</span>{" "}
                </button>
              </div>
              <div className="col-md-6 bg-head-2">
                <div>
                  <img
                    className="headicon-domonitor"
                    src="images/domonitor.png"
                    alt="#"
                  />
                </div>
              </div>
      ...
      <div className="domonitor2ndbg">
        <div className="domoniter-2ndbg">
          <h1>Explore DO Monitor features</h1>
          <div className="bg2ndhead-domonitor">
            ...
            <a href="#datavisual">
              <button className="btn-domonitor1">
                <img src="/images/icons_data_visualization2.png" alt="..." />
                <span className="btn1-domonitor">Data Visualization</span>
              </button>
            </a>
            <a href="#singlepane">
              <button className="btn-domonitor1">
                <img src="/images/icons_single_pane_of_glass.png" alt="..." />
          ...
          <div className="bg2ndhead-domonitor">
            <a href="#business">
              <button className="btn-domonitor1">
                <img src="/images/icons_business_monitoring.png" alt="..." />
                            ...
                            <div className="check-domonitor">
                              <ul>
                                ...
                                <li className="d-flex">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    Support for full range of industry standard
                                    protocols
                                  </p>
                                </li>
                                <li className="d-flex">
                    ...
                    <div className="col-md-7 qualitypara">
                      ...
                      <div className="sectioncards-domonitor">
                        <div className="row">
                              ...
                              <ul>
                                ...
                                <li className="d-flex">
                                  <img
                                    ...
                                    alt="..."
                                  />
                                  <p className="section-card-para-dom">Text</p>
                                </li>
                                <li className="d-flex">
                                  <img
                                    style={{ width: "23px", height: "23px" }}
                          ...
                          <div className="col-md-6">
                            <div className="check-domonitor-retrive">
                              <ul>
                                <li className="d-flex">
                                  <img
                                    style={{ width: "23px", height: "23px" }}
                            ...
                            <div className="check-domonitor">
                              <ul>
                                ...
                                <li className="d-flex">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    Immune to communication problems (in-memory
                                    or on-disk data buffering)
                                  </p>
                                </li>
                                <li className="d-flex">
                                  <img
                              ...
                              <ul>
                                <li className="d-flex">
                                  <img
                                    ...
                                    alt="..."
                                  />
                                  <p className="section-card-para-dom">macOS</p>
                                </li>
                                <li className="d-flex">
                                  <img
                                    style={{ width: "23px", height: "23px" }}
                              ...
                              <ul>
                                ...
                                <li className="d-flex">
                                  <img
                                    ...
                                    alt="..."
                                  />
                                  <p className="section-card-para-dom">IPMI</p>
                                </li>
                                <li className="d-flex">
                                  <img
                                    style={{ width: "23px", height: "23px" }}
                ...
                >
                  <div className="row">
                    <div className="col-md-7 qualitypara">
                      ...
                      <p className="qualitymatter text-justify">
                        Normalize and transform any kind of data before storing
                        it:
                      </p>
                      <div className="sectioncards-domonitor">
                        <div className="row">
                            ...
                            <div className="check-domonitor">
                              <ul>
                                ...
                                <li className="d-flex">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    JSONPath, XPath expressions and CSV to JSON
                                    transformation
                                  </p>
                                </li>
                                <li className="d-flex">
                            ...
                            <div className="check-domonitor">
                              <ul>
                                <li className="d-flex">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    Validate your data and check if the received
                                    value is in a specified value range or
                                    contains errors
                                  </p>
                                </li>
                                <li className="d-flex">
                          ...
                          <p>
                            Collect data in bulk and use it to populate multiple
                            dependent metrics:
                          </p>
                            ...
                            <div className="check-domonitor">
                              <ul>
                                ...
                                <li className="d-flex">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    Discard initial bulk data and store only the
                                    resulting metrics
                                  </p>
                                </li>
                              </ul>
                              ...
                              <ul>
                                ...
                                <li className="d-flex">
                                  <img
                                    ...
                                    alt="..."
                                  />
                                  <p className="section-card-para-dom">Email</p>
                                </li>
                                <li className="d-flex">
                                  <img
                                    style={{ width: "23px", height: "23px" }}
                          ...
                          <div className="check-domonitor">
                            <ul>
                              ...
                              <li className="d-flex">
                                ...
                                />
                                <p className="section-card-para-dom">
                                  Send a recovery message to all of the involved
                                  parties
                                </p>
                              </li>
            ...
            <div className="pillarnavs mt-4">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                >
                  <div className="row">
                    <div className="col-md-7 qualitypara">
                      <h5>Display the collected data in many possible ways</h5>
                      <p className="qualitymatter text-justify">
                      ...
                      <div>
                        ...
                        <p className="gainparain-domonitor">
                          Access your metrics, problems, reports and maps with a
                          click of a button.
                        </p>
                      </div>
                    </div>
                ...
                >
                  <div className="row">
                    <div className="col-md-7 qualitypara">
                      <h2>Analyze and correlate metrics with graphs</h2>
                      <p className="qualitymatter text-justify">
                              ...
                              <div className="check-domonitor">
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Display single or multiple metrics with a
                                      click of a button
                                    </p>
                                  </li>
                                </ul>
                ...
                >
                  <div className="row">
                    <div className="col-md-7 qualitypara">
                      <h4>
                        Keep track of your monitoring targets on an interactive
                        geo-map
                      </h4>
                                ...
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    <p className="section-card-para-dom">
                                      ...
                                      environment on Zabbix dashboards
                                    </p>
                                  </li>
                                  <li className="d-flex">
                                    <img
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Access any of your monitoring targets from
                                      the geo-map
                                    </p>
                                  </li>
                                </ul>
                              ...
                              <div className="check-domonitor">
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Follow the status of individual monitoring
                                      targets or the whole cluster
                                    </p>
                                  </li>
                                </ul>
                              </div>
                              ...
                              <div className="check-domonitor">
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Execute scripts within your infrastructure
                                      from the map screen
                                    </p>
                                  </li>
                                </ul>
                                ...
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    <p className="section-card-para-dom">
                                      ...
                                      your current view with a click of a button
                                    </p>
                                  </li>
                                </ul>
                              </div>
                ...
                >
                  <div className="row">
                    <div className="col-md-7 qualitypara">
                      <h2>Generate scheduled PDF reports</h2>
                      <p className="qualitymatter text-justify">
                          ...
                          <div className="col-md-12">
                            <ul>
                              ...
                              <li className="d-flex">
                                ...
                                />
                                <p className="section-card-para-dom">
                                  Can be scheduled for daily, weekly, or monthly
                                  delivery
                                </p>
                              </li>
                              <li className="d-flex">
                              ...
                              <div className="check-domonitor">
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Execute a script directly from a dashboard
                                      and remediate an issue or display
                          ...
                          <div className="col-md-12">
                            <ul>
                              ...
                              <li className="d-flex">
                                ...
                                />
                                <p className="section-card-para-dom">
                                  User permissions are respected when displaying
                                  data on dashboards
                                </p>
                              </li>
                            </ul>
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                >
                  <div className="row">
                    <div className="col-md-7">
                      <h2 className="sectionhead-domonitor">
                        Improve problem tracking with root cause analysisDefine
                        smart problem thresholds
                      </h2>
                      <p className="sectionpara-domonitor">
                        Correlate existing and incoming problems and perform root
                        cause analysis:
                      </p>
                      <div className="sectioncards-domonitor">
                        <div className="sectioncard-domonitor-4">
                          <div className="container sectioncardm-domonitor">
                            ...
                            <div className="check-domonitor">
                              ...
                              />
                              <p className="section-card-para-dom">
                                Define flexible problem correlation logic                            </p>
                            </div>
                            <div className="check-domonitor">
                              <img
                                src="/images/Mask groupdomonitor.png"
                        ...
                        <div className="sectioncard-domonitor-4">
                          <div className="container sectioncardm-domonitor">  
                            ...
                            <div className="check-domonitor">
                              ...
                              />
                              <p className="section-card-para-dom">
                                Multiple service status calculation algorithms                            </p>
                            </div>
                        ...
                        <div className="col-md-6">
                          <div className="check-domonitor">
                            <img
                              ...
                              alt="..."
                            />
                            <p> Analyze status of related services to perform SLA calculation
                            </p>
                          </div>
                          <div className="check-domonitor">
                            <img
...
Export your custom integration and share it with the DOM community
              ...
              >
                <div className="row">
                  <div className="col-md-7 qualitypara">
                    <h3 className="qualityhead">Keep track of your Kubernetes deployment on every level</h3>
                    <div className="check-domonitor">
                      <img
                        src="/images/Mask groupdomonitor.png"
                        alt="..."
                ...
                <div className="row">
                  <div className="col-md-7 qualitypara">
                    ...
                    <div className="check-domonitor">
                      ...
                      />
                      <p className="section-card-para-dom">
                        Automatically discover and start monitoring your cloud entities and components                              </p>
                    </div>
                    <div className="check-domonitor">
                      <img
                        src="/images/Mask groupdomonitor.png"
                    ...
                    <div className="check-domonitor">
                      ...
                      />
                      <p className="section-card-para-dom">
                        Collect metrics and events from your AWS EC2 instances                              </p>
                    </div>
                    <div className="check-domonitor">
                      <img
                        src="/images/Mask groupdomonitor.png"
                      ...
                      />
                      <p className="section-card-para-dom">
                        Automatically discover and start monitoring your AWS EBS instance volumes                              </p>
                    </div>
                    <div className="check-domonitor">
                      <img
                        src="/images/Mask groupdomonitor.png"
                      ...
                      />
                      <p className="section-card-para-dom">
                        Track the performance of your AWS RDS instances                              </p>
                    </div>
                    <div className="check-domonitor">
                      <img
                        src="/images/Mask groupdomonitor.png"
                    ...
                    <div className="check-domonitor">
                      ...
                      />
                      <p className="section-card-para-dom">
                        Discover and monitor the state of your Azure virtual machines                              </p>
                    </div>
                    <div className="check-domonitor">
                      <img
                        src="/images/Mask groupdomonitor.png"
                      ...
                      />
                      <p className="section-card-para-dom">
                        Monitor the resource usage and state of your Azure MySQL instances                              </p>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-md-7 qualitypara">
                    ...
                    <div className="row">
                      ...
                      <p className="qualitymatter text-justify">Monitor VMware metrics such as:
                      </p>
                      <div className="row">
                        <div className="col-md-6">
                          <ul>
                ...
                >
                  <div className="row">
                    <div className="col-md-7">
                      ...
                      <p className="sectionpara-domonitor">
                        Create your own custom user roles with a granular set of
                        permissions for different types of users in your
                        environment.
                      </p>
                      <p className="sectionpara-domonitor">
                ...
                >
                  <div className="row">
                    <div className="col-md-7">
                      ...
                      <p className="sectionpara-domonitor">
                        Once entered, you have the option to hide your sensitive
                ...
                >
                  <div className="row">
                    <div className="col-md-7">
                      ...
                      <p className="sectionpara-domonitor">
                        Track changes in your environment by utilizing the Audit
                        log:
                      </p>
                      <div className="sectioncards-domonitor">
                        <div className="sectioncard-domonitor-3">
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          <div className="check-domonitor">
                            ...
                            />
                            <p className="section-card-para-dom">
                              Use templates to manage monitoring of thousands of
                              devices, make local overrides if needed
                            </p>
                          </div>
                        </div>
                        <div className="col-md-6">
                              ...
                              <div className="check-domonitor">
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Customize existing templates or build new
                                      custom templates
                                    </p>
                                  </li>
                                  <li className="d-flex">
                              ...
                              <div className="check-domonitor">
                                <ul>
                                  ...
                                  <li className="d-flex">
                                    ...
                                    />
                                    <p className="section-card-para-dom">
                                      Specify IP address ranges for the network
                                      scan
                                    </p>
                                  </li>
                                </ul>
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              <div className="check-domonitor">
                                ...
                                />
                                <p className="section-card-para-dom">
                                  Use resource discovery to automatically create
                                  monitoring targets based on the received data
                                </p>
                              </div>
                            </div>
                          </div>
              ...
              >
                <div className="row">
                  <div className="col-md-7">
                    ...
                    <p className="sectionpara-domonitor">
                      Define custom device onboarding and offboarding workflow,
                      ...
                      <div>
                        <div className="sectioncardm-domonitor">
                          <div className="">
                            ...
                            <div>
                              <div className="check-domonitor"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-6">
                                <div className="check-domonitor">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    Having HA enables you to perform seamless OS
                                    level maintenance and deploy the latest OS
                            ...
                            <div className="row">
                              <div className="col-md-6">
                                <div className="check-domonitor">
                                  ...
                                  />
                                  <p className="section-card-para-dom">
                                    Deploy multiple frontendsall over the globe
                                    for optimal UX across different teams or
                                    departments
                                  </p>
                                </div>
                              </div>
                      ...
                      <div className="sectioncardm-domonitor">
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            may opt-in to store the history data for 6 months
                            while storing hourly trends for 2 years:
                          </p>
                        </div>
